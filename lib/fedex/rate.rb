module Fedex
  ...
  class Rate
    ...
    attr_accessor :service_type, :rate_type, :rate_zone, :total_biling_weight, :total_freight_discounts, :total_net_charge, :total_taxes, :total_net_freight, :total_surcharges, :total_base_charge
